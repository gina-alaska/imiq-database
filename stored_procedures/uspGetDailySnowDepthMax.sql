...
/****** Object:  StoredProcedure [dbo].[uspGetDailySnowDepthMax]    Script Date: 01/09/2015 13:45:37 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Create the daily snow depth max.  
-- Units: meters, format Decimal(6,3)
-- =============================================
CREATE PROCEDURE [dbo].[uspGetDailySnowDepthMax] 
...
BEGIN
    ...
    BEGIN
	    ...
	    BEGIN
	        ...
	        INSERT INTO DailySnowDepthMaxDataValues (DataValue,UTCDateTime, VariableID,SiteID,MethodID)
