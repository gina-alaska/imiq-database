...
/****** Object:  StoredProcedure [dbo].[uspGetDailySoilTempMin]    Script Date: 01/09/2015 13:46:28 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Create the daily soil temp min
-- =============================================
CREATE PROCEDURE [dbo].[uspGetDailySoilTempMin] 
...
BEGIN
    ...
    BEGIN
		...
		SELECT CONVERT(Date,dv.LocalDateTime), MIN(dv.DataValue)
	    ...
	    BEGIN
	        INSERT INTO DailySoilTempMinDataValues (DataValue,UTCDateTime, VariableID,SiteID,MethodID,OffsetTypeID,OffsetValue)
