...
CREATE TABLE tables.odmdatavalues_metric_2 AS 
 SELECT v.valueid,
    v.datavalue,
    v.valueaccuracy,
    v.localdatetime,
...
ALTER TABLE tables.odmdatavalues_metric_2
ADD CONSTRAINT odmdatavalues_metric_valueid PRIMARY KEY (valueid);

CREATE INDEX odmdatavalues_metric_siteid_idx
  ON tables.odmdatavalues_metric_2
  USING btree
  (siteid);
...
ALTER TABLE tables.odmdatavalues_metric_2
  OWNER TO imiq;
GRANT ALL ON TABLE tables.odmdatavalues_metric_2 TO imiq;
GRANT ALL ON TABLE tables.odmdatavalues_metric_2 TO asjacobs;
GRANT ALL ON TABLE tables.odmdatavalues_metric_2 TO chaase;
GRANT SELECT ON TABLE tables.odmdatavalues_metric_2 TO imiq_reader;
GRANT ALL ON TABLE tables.odmdatavalues_metric_2 TO rwspicer;
COMMENT ON TABLE tables.odmdatavalues_metric_2
