...
## file name for sc_list_file, a text file with ISH sitecodes, one on each line
sc_list_file = sys.argv[1]

## template file, use __ISH_datavalues_args_template.yaml
...
for site in sc_list:
    ...
    comment = "#Y2I argument file for ISH site " + site + "\n"
