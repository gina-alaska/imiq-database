...
-- Function: tables.uspgetdailysoiltempmin(integer)

-- DROP FUNCTION tables.uspgetdailysoiltempmin(integer);

CREATE OR REPLACE FUNCTION tables.uspgetdailysoiltempmin(site_id integer)
  RETURNS void AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tables.uspgetdailysoiltempmin(integer)
  OWNER TO imiq;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmin(integer) TO public;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmin(integer) TO imiq;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmin(integer) TO asjacobs;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmin(integer) TO rwspicer;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmin(integer) TO chaase;
