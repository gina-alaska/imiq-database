-- Function: tables.uspgetdailysoiltempmax(integer)

-- DROP FUNCTION tables.uspgetdailysoiltempmax(integer);

CREATE OR REPLACE FUNCTION tables.uspgetdailysoiltempmax(site_id integer)
  RETURNS void AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tables.uspgetdailysoiltempmax(integer)
  OWNER TO imiq;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmax(integer) TO public;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmax(integer) TO imiq;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmax(integer) TO asjacobs;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmax(integer) TO rwspicer;
GRANT EXECUTE ON FUNCTION tables.uspgetdailysoiltempmax(integer) TO chaase;
