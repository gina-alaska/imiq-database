...
VariableID=692
from DAILY_SnowDepthDataValues v, NHD_HUC8 as Bounds, Sites as s
where (v.DataValue >= 0 and v.DataValue < 12) /* needed to make sure that the site never showed up in the arctic, in any of the HUCs */
