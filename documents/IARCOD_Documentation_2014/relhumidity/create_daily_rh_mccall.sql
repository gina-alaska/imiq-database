...
from
(select AT.SiteID as SiteID,AT.UTCDateTime as UTCDateTime,AT.DataValue as AT,RH.DataValue as RH
...
where AT.SiteID in (select siteid from sites where sourceid in(178)) and AT.VariableID=686
