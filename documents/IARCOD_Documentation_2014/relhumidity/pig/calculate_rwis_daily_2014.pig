...
dp = foreach filtered generate siteid,CONCAT(SUBSTRING(timestamp,0,11),'00:00:00') as hour,airtemp,(LOG((0.611*(EXP((17.3*airtemp)/(airtemp+237.3))))*rh/100)+0.4926)/(0.0708-0.00421*LOG((0.611*(EXP((17.3*airtemp)/(airtemp+237.3))))*rh/100)) as dew;
...
store ordered_rh into 'rwis_processed_daily_2014';
