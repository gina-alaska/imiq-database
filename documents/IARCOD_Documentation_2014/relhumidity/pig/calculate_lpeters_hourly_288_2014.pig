raw = load '/Users/asjacobs/Documents/AWS/data/lpeters_rh_at_288_2014.csv' using PigStorage(',') as (siteid:chararray,timestamp:chararray,rh:float,airtemp:float);
...
store ordered_rh into 'lpeters_processed_hourly_288_2014';
