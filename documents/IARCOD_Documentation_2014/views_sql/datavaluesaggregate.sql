...
/****** Object:  View [dbo].[DataValuesAggregate]    Script Date: 09/04/2014 10:51:00 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'DataValuesAggregate'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'DataValuesAggregate'
GO
